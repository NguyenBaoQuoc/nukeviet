...
<div class="nv-fullbg">
    <form method="post" action="{ACTION_FILE}" onsubmit="return nv_validForm(this);" novalidate>
		...
		<div class="form-group">
			<div class="input-group">
				<span class="input-group-addon">
					<em class="fa fa-calculator fa-lg fa-horizon"></em>
				</span>
				<input type="text" maxlength="60" value="{CONTENT.ftax}" name="ftax" class="form-control required" placeholder="Mã số thuế" onkeypress="nv_validErrorHidden(this);" data-mess="Mã số thuế không hợp lệ" />
			</div>
		</div>
		...
		<div class="form-group">
			<div class="input-group">
                ...
                <input type="text" maxlength="60000" value="{CONTENT.fphone}" name="fphone" class="form-control" placeholder="{LANG.phone}" />
            </div>
        </div>
        <div class="form-group">
			<div class="input-group">
