...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $ftax = nv_substr($nv_Request->get_title('ftax', 'post', '', 1), 0, 100);
    ...
    (cid, cat, title, content, send_time, sender_id, sender_name,sender_tax, sender_email, sender_phone, sender_address, sender_ip, is_read, is_reply) VALUES
    (' . $fpart . ', :cat, :title, :content, ' . NV_CURRENTTIME . ', ' . $sender_id . ', :sender_name, :sender_tax, :sender_email, :sender_phone, :sender_address, :sender_ip, 0, 0)';
    $data_insert = array();
    $data_insert['cat'] = $fcat;
    $data_insert['title'] = $ftitle;
    $data_insert['content'] = $fcon;
    $data_insert['sender_name'] = $fname;
    $data_insert['sender_tax'] = $ftax;
